...
@${CLAUDE_PLUGIN_ROOT}/references/ceremony-scaling.md). Verify runs at every gear; scale the output:
...
The full checklist below is the **Deep** path; at Standard use only the readiness check + Jira
